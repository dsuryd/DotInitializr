...
{
   /// <summary>
   /// Auto generated by "https://app.quicktype.io/" from "http://json.schemastore.org/template" (draft-04 schema).
   /// </summary>
   ...
   public partial class Generator
   {
      ...
      /// <summary>
      /// The friendly name of the symbol to be displayed to the user. This property is localizable.
      /// </summary>
   ...
   { Casing, Coalesce, Constant, Evaluate, Guid, Join, Now, Port, Random, Regex, RegexMatch, Switch };
   ...
   { Bind, Computed, Derived, Generated, Parameter };
