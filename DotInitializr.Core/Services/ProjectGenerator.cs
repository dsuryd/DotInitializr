...
namespace DotInitializr
{
	...
	public class ProjectGenerator : IProjectGenerator
	{
		...
		public ProjectGenerator(IEnumerable<IConfigurableTemplateSource> templateSources, IEnumerable<ITemplateRenderer> renderers, ITemplateMetadataReader templateReader)
		{
