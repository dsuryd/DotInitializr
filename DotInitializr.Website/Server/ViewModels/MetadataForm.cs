...
namespace DotInitializr.Website.Server
{
	public class MetadataForm : BaseVM
	{
		...
		[Ignore]
		public ReactiveProperty<AppConfigurationV2.Template> TemplateChangedEvent { get; } = new ReactiveProperty<AppConfigurationV2.Template>();

		[Ignore]
		public TemplateMetadata ActiveMetadata => MetadataLoadedEvent.Value as TemplateMetadata;

		public MetadataForm(ITemplateMetadataReaderV2 templateReader)
		{
		...
		private TemplateMetadata GetMetadata(AppConfigurationV2.Template template)
		{
